...
router.put('/id/:id', authHandlers.admin, booksHandlers.update)
router.get('/id/:id', authHandlers.noAdmin, booksHandlers.getOne)
router.delete('/id/:id', authHandlers.admin, booksHandlers.delete)
